...
fn encrypted_private_key() {
    ...
    key.unlock(
        ...
        |_pub_params, k| {
            ...
            match k {
                PlainSecretParams::RSA(k) => {
                    assert_eq!(k.e().to_be_bytes(), hex::decode("010001").unwrap().into_boxed_slice());
                    assert_eq!(k.n().to_be_bytes(), hex::decode("").unwrap().into_boxed_slice());
                    assert_eq!(k.d().to_be_bytes(), hex::decode("").unwrap().into_boxed_slice());
                    assert_eq!(k.primes()[0].to_be_bytes(), hex::decode("C62B8CD033331BFF171188C483B5B87E41A84415A004A83A4109014A671A5A3DA0A467CDB786F0BB75354245DA0DFFF53B6E25A44E28CBFF8CC1AC58A968AF57").unwrap().into_boxed_slice());
                    assert_eq!(k.primes()[1].to_be_bytes(), hex::decode("C831D89F49E642383C115413B2CB5F6EC09012B50C1E8596877E8F7B88C82C8F14FC354C21B6032BEF78B3C5EC92E434BEB2436B12C7C9FEDEFD866678DBED77").unwrap().into_boxed_slice());
                }
