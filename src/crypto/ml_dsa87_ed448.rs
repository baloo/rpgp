...
impl SecretKey {
    ...
    pub fn generate<R: RngCore + CryptoRng + ?Sized>(rng: &mut R) -> Self {
        let ed448 = ed448::SigningKey::generate(rng);
    ...
    pub fn try_from_bytes(
        ...
        let ed448 = ed448::SigningKey::from(
            ed448::SecretKey::try_from(&ed448[..]).expect("invariant violation"),
        );
        // use the seed format
...
pub fn verify(
    ...
    let ed_sig = ed448::Signature::try_from(&sig_bytes[..114])?;
